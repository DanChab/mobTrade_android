...
public class JsonReq extends Activity implements OnClickListener{

    private String TAG = JsonReq.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPrice = (TextView) findViewById(R.id.ratingTextView);
