package com.jotifica.jotifica.activity;
...
import com.jotifica.jotifica.App.Config;
import com.jotifica.jotifica.R;
import com.jotifica.jotifica.Utils.NotificationUtils;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ic_shoppingBasket:
                Intent intent = new Intent(MainActivity.this,AdvertiserslistMain.class);
